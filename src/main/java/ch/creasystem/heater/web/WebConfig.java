...
public class WebConfig extends WebMvcConfigurerAdapter {
	...
	public void addViewControllers(ViewControllerRegistry registry) {
		...
		registry.addViewController("/heaterconfig").setViewName("heaterconfig");
		registry.addViewController("/periodedit").setViewName("periodedit");
	 ...
	 *
	 * @return filter adding "Cache-Control: no-cache" HTTP header to all URLs
	 *         belwow "/api"
	 */
	@Bean
